...
If you'd like to be featured in one of our blog articles this starts at just **£20** (e.g. Be the no.1 cafe in our list of cafe's in the area). If you're interested simply email us. 

### Events

If you're running an event we'd love to promote it on the site to help locals discover it. Paid events are **£40** per listing or **free** for free events. Each event gets its own unique page for people to read info about it and is features on our designated event's section as well as around the site in different promotional spots. 
