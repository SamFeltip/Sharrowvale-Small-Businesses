...
At Perfectionery, you can buy a delicious range of bread, pastries, cakes, and savoury items.

import Cake1 from "../../assets/images/businesses/perfectionery/cake_one.jpg";
import Cake2 from "../../assets/images/businesses/perfectionery/cake_two.jpg";
import Cake3 from "../../assets/images/businesses/perfectionery/cake_three.jpg";
import Cake4 from "../../assets/images/businesses/perfectionery/cake_four.jpg";

<BusinessLightBox imgs={[Cake2, Cake1, Cake4, Cake3]} />

Together with their hardworking staff, Perfectionery also offers a range of catering services for 
