        ...
        <>
            ...
            >
                ...
                <div className="col-span-1 md:col-start-4 row-span-1 md:row-span-2">
                    <div className="transition-[height] duration-300 ease-in-out flex flex-row gap-4 overflow-y-auto md:h-[300px] lg:h-[400px] md:flex-col">
                        {slides.slice(1).map((slide, index) => (
                            <img
                                className="w-[200px] aspect-[3/2] cursor-pointer rounded-lg object-cover md:h-auto md:w-auto md:rounded-xl"
                                src={slide.src}
                                alt=""
                                key={index}
