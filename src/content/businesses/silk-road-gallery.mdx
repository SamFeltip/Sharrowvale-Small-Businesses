...
Silk Road Gallery is a local spot on Sharrow Vale where each item tells its own story. Run by Peter Bennion and Kay Wallace, 
...
photograph comes with a story of adventure. Peter's trips to markets and historic sites turn everyday finds into keepsakes that
let you experience a bit of far-off lands right here in Sheffield.

Inside, you'll discover a mix of items—from fabrics and carvings to art and photos that capture the spirit of India. Peter's 
connection to India is clear in his collection, reflecting his many journeys to its lively markets and ancient sites.
